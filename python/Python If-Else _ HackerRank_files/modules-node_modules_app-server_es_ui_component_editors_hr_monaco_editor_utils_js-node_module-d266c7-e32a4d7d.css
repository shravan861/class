.hr-monaco-editor .vs .read-only{background-color:#e7eeef}.hr-monaco-editor .vs .selected-text~.read-only{background-color:#add6ff}.hr-monaco-editor .vs-dark .find-selector{background-color:#fff}.hr-monaco-editor .vs-dark .read-only{background-color:#222b3b}.hr-monaco-editor .vs-dark .selected-text~.read-only{background-color:#264f78}.hr-monaco-editor .hc-black .read-only{background-color:#e7eeef}.hr-monaco-editor .hc-black .selected-text~.read-only{background-color:#9acd32}.hr-monaco-editor .monaco-placeholder{position:absolute;display:block;font-size:15px;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-family:SourceCodePro;color:#068932;top:2px;left:54px}.hr-monaco-editor .monaco-placeholder-show{top:1px;left:98px}
.autocomplete-status__text{flex:1;padding-right:5px;padding-left:5px}.autocomplete-status__text--alert{color:var(--color-autocomplete-status-alert-text,#db7100)}.autocomplete-status__text--error{color:var(--color-autocomplete-status-error-text,#d11534)}.autocomplete-status__text--ready{color:var(--color-autocomplete-status-ready-text,#068932)}.autocomplete-status--loading{color:var(--color-autocomplete-status-loading-icon,#39424e)}.autocomplete-status--disabled{color:var(--color-autocomplete-status-disabled-icon,#39424e)}.autocomplete-status--alert{color:var(--color-autocomplete-status-alert-icon,#db7100)}.autocomplete-status--error{color:var(--color-autocomplete-status-error-icon,#d11534)}.autocomplete-status--ready{color:var(--color-autocomplete-status-ready-icon,#068932)}
...
/*# sourceMappingURL=https://hrcdn.net/fcore/assets/sourcemaps/modules-node_modules_app-server_es_ui_component_editors_hr_monaco_editor_utils_js-node_module-d266c7-e32a4d7d.css.map*/